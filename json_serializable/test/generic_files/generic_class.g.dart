...
GenericClass<T, S> _$GenericClassFromJson<T extends num, S>(
  ...
  ..fieldInt = GenericClass._dataFromJson(
    json['fieldInt'] as Map<String, dynamic>,
  )
  ..fieldT = GenericClass._dataFromJson(json['fieldT'] as Map<String, dynamic>)
  ..fieldS = GenericClass._dataFromJson(json['fieldS'] as Map<String, dynamic>);
...
GenericClassWithConverter<T, S> _$GenericClassWithConverterFromJson<
  T extends num,
  S
>(Map<String, dynamic> json) => GenericClassWithConverter<T, S>()
  ...
  ..fieldT = _$JsonConverterFromJson<Map<String, dynamic>, T>(
    json['fieldT'],
    _SimpleConverter<T?>().fromJson,
  )
  ..fieldS = _$JsonConverterFromJson<Map<String, dynamic>, S>(
    json['fieldS'],
    _SimpleConverter<S?>().fromJson,
  )
  ..duration = const _DurationMillisecondConverter.named().fromJson(
    (json['duration'] as num?)?.toInt(),
  )
  ..listDuration = const _DurationListMillisecondConverter().fromJson(
    (json['listDuration'] as num?)?.toInt(),
  );
...
Map<String, dynamic> _$GenericClassWithConverterToJson<T extends num, S>(
  ...
  'fieldT': _$JsonConverterToJson<Map<String, dynamic>, T>(
    instance.fieldT,
    _SimpleConverter<T?>().toJson,
  ),
  'fieldS': _$JsonConverterToJson<Map<String, dynamic>, S>(
    instance.fieldS,
    _SimpleConverter<S?>().toJson,
  ),
  'duration': const _DurationMillisecondConverter.named().toJson(
    instance.duration,
  ),
  'listDuration': const _DurationListMillisecondConverter().toJson(
...
Issue1047Class<T> _$Issue1047ClassFromJson<T>(
  Map<String, dynamic> json,
  T Function(Object? json) fromJsonT,
) => Issue1047Class<T>(node: fromJsonT(json['node']));
