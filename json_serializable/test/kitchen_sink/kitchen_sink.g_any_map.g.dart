...
KitchenSink _$KitchenSinkFromJson(Map json) {
  ...
  val.objectDateTimeMap = (json['objectDateTimeMap'] as Map).map(
    (k, e) => MapEntry(k as Object, DateTime.parse(e as String)),
  );
  val.nullableSimpleObjectMap = (json['nullableSimpleObjectMap'] as Map).map(
    (k, e) => MapEntry(
      k as String,
  ...
  val.simpleObject = SimpleObject.fromJson(json['simpleObject'] as Map);
  ...
  val.recordField = _$recordConvertAnyNullable(
    json['recordField'],
    ($jsonValue) => (
