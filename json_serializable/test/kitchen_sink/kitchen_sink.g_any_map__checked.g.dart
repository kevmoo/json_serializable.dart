...
JsonConverterTestClass _$JsonConverterTestClassFromJson(
  Map json,
) => $checkedCreate('JsonConverterTestClass', json, ($checkedConvert) {
  final val = JsonConverterTestClass(
    $checkedConvert(
      'duration',
      (v) =>
          const DurationMillisecondConverter().fromJson((v as num?)?.toInt()),
    ),
    $checkedConvert(
      'durationList',
      (v) => (v as List<dynamic>)
          .map(
            (e) => const DurationMillisecondConverter().fromJson(
              (e as num?)?.toInt(),
            ),
          )
          .toList(),
    ...
    $checkedConvert(
      'numberSilly',
      (v) => TrivialNumberConverter.instance.fromJson((v as num?)?.toInt()),
    ),
    $checkedConvert(
      'numberSillySet',
      (v) => (v as List<dynamic>)
    ...
    $checkedConvert(
      'dateTime',
      (v) => const EpochDateTimeConverter().fromJson((v as num?)?.toInt()),
    ),
    $checkedConvert(
      'trivialString',
...
JsonConverterGeneric<S, T, U> _$JsonConverterGenericFromJson<S, T, U>(
  Map json,
) => $checkedCreate('JsonConverterGeneric', json, ($checkedConvert) {
