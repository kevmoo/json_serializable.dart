...
Map<String, dynamic> _$KitchenSinkToJson(
  ...
  'nullableSimpleObjectMap': instance.nullableSimpleObjectMap.map(
...
JsonConverterTestClass _$JsonConverterTestClassFromJson(
  ...
  (json['bigIntMap'] as Map<String, dynamic>).map(
    (k, e) => MapEntry(k, const BigIntStringConverter().fromJson(e as String)),
  ),
...
JsonConverterGeneric<S, T, U> _$JsonConverterGenericFromJson<S, T, U>(
  ...
  (json['itemMap'] as Map<String, dynamic>).map(
    (k, e) =>
        MapEntry(k, GenericConverter<U>().fromJson(e as Map<String, dynamic>)),
  ),
);
