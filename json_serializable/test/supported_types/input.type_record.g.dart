...
SimpleClassOfBool _$SimpleClassOfBoolFromJson(Map<String, dynamic> json) =>
    SimpleClassOfBool(
      _$recordConvert(
        json['value'],
        ($jsonValue) =>
            ($jsonValue[r'$1'] as bool, named: $jsonValue['named'] as bool),
      ),
    );
...
SimpleClassOfDynamic _$SimpleClassOfDynamicFromJson(
  ...
  _$recordConvert(
    json['value'],
    ($jsonValue) => ($jsonValue[r'$1'], named: $jsonValue['named']),
  ),
);
...
SimpleClassOfNum _$SimpleClassOfNumFromJson(Map<String, dynamic> json) =>
    SimpleClassOfNum(
      _$recordConvert(
        json['value'],
        ($jsonValue) =>
            ($jsonValue[r'$1'] as num, named: $jsonValue['named'] as num),
      ),
    );
...
SimpleClassOfObject _$SimpleClassOfObjectFromJson(Map<String, dynamic> json) =>
    SimpleClassOfObject(
      _$recordConvert(
        json['value'],
        ($jsonValue) =>
            ($jsonValue[r'$1'] as Object, named: $jsonValue['named'] as Object),
      ),
    );
...
SimpleClassOfString _$SimpleClassOfStringFromJson(Map<String, dynamic> json) =>
    SimpleClassOfString(
      _$recordConvert(
        json['value'],
        ($jsonValue) =>
            ($jsonValue[r'$1'] as String, named: $jsonValue['named'] as String),
      ),
    );
...
SimpleClassOfUriNullable _$SimpleClassOfUriNullableFromJson(
  ...
  _$recordConvert(
    json['value'],
    ($jsonValue) => (
      $jsonValue[r'$1'] == null ? null : Uri.parse($jsonValue[r'$1'] as String),
      named: $jsonValue['named'] == null
          ? null
