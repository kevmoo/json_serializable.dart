...
SimpleClass _$SimpleClassFromJson(Map<String, dynamic> json) => SimpleClass(
  ...
  (json['withDefault'] as List<dynamic>?)?.toSet() ?? {42, true, false, null},
);
...
SimpleClassNullable _$SimpleClassNullableFromJson(Map<String, dynamic> json) =>
    SimpleClassNullable(
      (json['value'] as List<dynamic>?)?.toSet(),
      (json['withDefault'] as List<dynamic>?)?.toSet() ??
          {42, true, false, null},
    );
...
SimpleClassOfDynamic _$SimpleClassOfDynamicFromJson(
  Map<String, dynamic> json,
) => SimpleClassOfDynamic((json['value'] as List<dynamic>).toSet());
...
SimpleClassNullableOfDynamic _$SimpleClassNullableOfDynamicFromJson(
  Map<String, dynamic> json,
) => SimpleClassNullableOfDynamic((json['value'] as List<dynamic>?)?.toSet());
...
SimpleClassOfFromJsonDynamicParam _$SimpleClassOfFromJsonDynamicParamFromJson(
  ...
  (json['value'] as List<dynamic>).map(FromJsonDynamicParam.fromJson).toSet(),
);
...
SimpleClassOfObjectNullable _$SimpleClassOfObjectNullableFromJson(
  Map<String, dynamic> json,
) => SimpleClassOfObjectNullable((json['value'] as List<dynamic>).toSet());
